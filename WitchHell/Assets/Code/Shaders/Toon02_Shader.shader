...
Shader "Toon02_Shader"
{
	Properties
	{
		_ASEOutlineWidth( "Outline Width", Float ) = 1.33
		...
		[Toggle(_SWITCHFADEUP_ON)] _SwitchFadeUp("Switch FadeUp", Float) = 0
	...
	SubShader
	{
		...
		#pragma target 3.0
		#pragma shader_feature_local _SWITCHFADEUP_ON
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			#ifdef _SWITCHFADEUP_ON
				float4 staticSwitch122 = ( temp_output_65_0 * ( 1.0 - saturate( ( ( ase_worldPos / ( _Scale * 2.0 ) ).y + _OffsetFadeUp ) ) ) );
			#else
				float4 staticSwitch122 = temp_output_65_0;
			#endif
...
/*ASEBEGIN
Version=18503
320;73;1159;540;382.4648;-338.2206;1;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;129;49.98102,696.2933;Inherit;False;Property;_Scale;Scale;24;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;130;51.98102,802.2933;Inherit;False;Constant;_Float0;Float 0;23;0;Create;True;0;0;False;0;False;2;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;125;220.981,714.2933;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.WorldPosInputsNode;123;-157.019,431.2933;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.SimpleDivideOpNode;128;367.981,512.2933;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;133;636.981,688.2933;Inherit;False;Property;_OffsetFadeUp;OffsetFadeUp;23;0;Create;True;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.BreakToComponentsNode;131;511.981,511.2933;Inherit;False;FLOAT3;1;0;FLOAT3;0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
...
Node;AmplifyShaderEditor.SimpleAddOpNode;132;821.981,564.2933;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;134;949.981,564.2933;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;135;1101.823,549.1178;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;136;793.8702,233.0276;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;127;68.98102,511.2933;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.ObjectToWorldTransfNode;126;-165.019,587.2933;Inherit;False;1;0;FLOAT4;0,0,0,1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.GetLocalVarNode;116;787.5062,790.5366;Inherit;False;8;Normal_LightDir;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;122;955.5847,-17.50856;Inherit;False;Property;_SwitchFadeUp;Switch FadeUp;22;0;Create;True;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
WireConnection;122;1;65;0
WireConnection;122;0;136;0
...
ASEEND*/
//CHKSM=AE09A53B3A1D9312F3CEF38BE90BC04594EB836A